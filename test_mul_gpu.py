...
parser.add_argument('--test_dir',default='/home/lihaoran/datasets/University-Release/test',type=str, help='./test_data')
parser.add_argument('--name', default='no_street_share_d0.75_256_s1_LPN4_lr0.01_decouple_one-deloss_debug', type=str, help='save model path')
...
parser.add_argument('--epoch', type=int,help='训练选择固定的epoch权重')
parser.add_argument('--modelNum', type=int,help='用来区分模型')
parser.add_argument('--num',default=0, type=int,help='用来区分模型')
